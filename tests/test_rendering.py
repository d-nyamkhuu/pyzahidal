            ...
            Surface(
                Columns(
                    Stack(
                        ...
                        "Salt.",
                        "Dusk | French Vanilla",
                        Button("Starts at $12.99", href="#"),
                        gap="16px",
                    ),
                    Surface("", tone="ghost", background_image="https://example.com/hero.jpg", padding="140px 0"),
                    widths=["52%", "48%"],
                    gap="18px",
                ),
                padding="24px",
...
def test_curated_style_footer_can_be_composed_from_primitives():
    html = Surface(
        Stack(
            Columns(
                Stack("Acme Studio", "Quick links", Menu([MenuItemSpec("About", href="#"), MenuItemSpec("Shop", href="#")]), gap="8px"),
                Stack("Follow us", SocialLinks([SocialLinkSpec(href="#", icon_src="https://example.com/icon.png", alt="X")], mode="icon"), gap="8px", align="right"),
                widths=["60%", "40%"],
            ),
            Metric("$35.98", label="Amount charged", detail="Visa ****6754"),
            gap="20px",
        ),
        padding="24px",
        tone="subtle",
